    ...
    <footer className="bg-secondary-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Seu Nome</h3>
            <p className="text-secondary-300 mb-4">
              Jornalista profissional especializado em contar histórias que importam.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Início", "Sobre", "Portfólio", "Experiência", "Contato"].map((item) => (
                <li key={item}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-2 text-secondary-300">
              ...
              <li>Localização: Sua Cidade, Estado, País</li>
            </ul>
          </div>
        </div>
